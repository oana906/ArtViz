(function () {
    //data vars
    var dimensionsArray = ["BirthYear", "DeathYear", "Country", "Description", "Movement", "Field", "Gender"];
    var dimensions = {};
    var documents;
    ...
    var redraw = function () {
        ...
        documents.forEach(function (d, i) {
            d.__filtered__ && (html += "<p>" + d.Name + " : <b>" + d.BirthYear + "-" + d.DeathYear + ". </b>" + "<span class='price-motivation'> " + d.Description + "</span>" + ", Movemement: " + "<span class='price-motivation'> " + d.Movement + "</span>" + ", Field: " + "<span class='price-motivation'> " + d.Field + "</span>" + ", " + "<a href=" + d.personURL + ">" + d.personURL + "</a>" + "</p>") && (aa[i] = "<p>" + d.Name + " : <b>" + d.BirthYear + "-" + d.DeathYear + ". </b>" + "<span class='price-motivation'> " + d.Description + "</span>" + "||" + d.Movement + "||" + d.Field + "||" + d.personURL)
        });
        ...
        for (var index in aa) {
            ...
            if (aa[index].split("||")[0] === temp.split("||")[0]) {
                if (mm.indexOf(aa[index].split("||")[1]) == -1) {

                    mm += aa[index].split("||")[1] + ", ";

                }
                if (ff.indexOf(aa[index].split("||")[2]) == -1) {

                    ff += aa[index].split("||")[2] + ", ";

                }
            }
            if (aa[index].split("||")[0].indexOf(temp.split("||")[0]) == -1) {

                hh += aa[index].split("||")[0] + " Movement::" + mm + " Field::" + ff + "\n";
                mm = "";
                ff = "";
                ii = 0;
            }
        ...
        //console.log("!!!!" + hh);
        d3.select("#results").html(hh);
        d3.select("#results-count").html("Founds " + d3.select("#results").selectAll("p")[0].length);
    }
    ...
    d3.csv("data/artist.csv", onDataLoaded);
}());